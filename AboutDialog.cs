...
namespace DeskMadeline
{
    ...
    internal sealed class AboutDialog : Form
    {
        ...
        public AboutDialog()
        {
            ...
            y = AddLink(ref y, Loc.T("About.ContinuedBy"), "solstice23", ProjectUrl);
            y += 8;
            y = AddLink(ref y, Loc.T("About.FanProject"), "Celeste", CelesteUrl);

            // As wide as the widest line already is, and never so narrow that the paragraph
            // below turns into a column.
            int content = 0;
            foreach (Control control in Controls) content = Math.Max(content, control.Right);
