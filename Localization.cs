...
namespace DeskMadeline
{
    ...
    internal static class Loc
    {
        ...
        static readonly Dictionary<string, string> english = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Update.OnGitHub"] = "Download on GitHub",
            ["Update.Install"] = "Update",
            ["Update.Manually"] = "Manually Check on GitHub",
            ["Update.Downloading"] = "Downloading the new build...",
            ["Update.Progress"] = "{0} of {1}  ·  {2}%",
            ["Update.DownloadFailed"] = "The new build could not be downloaded.",
            ["Update.HandoverFailed"] = "The new build was downloaded but could not be put in place.",
            ["Update.NotABuild"] = "What came down does not look like a build of this.",
            ["Update.Later"] = "Later",
            ["About.OriginalBy"] = "Originally created by {0}",
            ["About.ContinuedBy"] = "Extended and Maintained by {0}",
            ...
            ["Sfx.WhyNoRuntime"] = "No sound: no 64-bit FMOD found. Everest's build installs one into lib64-win-x64; those two DLLs also work beside DeskMadeline.exe.",
            ["Sfx.WhyNoBanks"] = "No sound: Celeste's sound banks were not found. Point at the game under Celeste folder.",
            ["Sfx.WhyUnavailable"] = "No sound: FMOD would not start. See pet_debug.log.",
            ...
            ["Windows.KevinBlocks"] = "Kevin Blocks",
            ...
            ["Menu.SpawnBumper"] = "Spawn bumper",
            ["Menu.SpawnPuffer"] = "Spawn pufferfish",
            ["Menu.Autonomy"] = "Wander on her own",
            ["Menu.AutonomyDebug"] = "Autonomy debug",
            ["Menu.Spawn"] = "Spawn",
            ...
            ["Menu.RemoveAllBumpers"] = "Remove all bumpers",
            ["Menu.RemoveAllPuffers"] = "Remove all pufferfish",
            ...
            new Dictionary<string, Dictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["zh"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["Update.Download"] = "下载",
                ["Update.OnGitHub"] = "在 GitHub 下载",
                ["Update.Install"] = "更新",
                ["Update.Manually"] = "在 GitHub 上手动查看",
                ["Update.Downloading"] = "正在下载新构建...",
                ["Update.Progress"] = "{0} / {1}  ·  {2}%",
                ["Update.DownloadFailed"] = "无法下载新构建。",
                ["Update.HandoverFailed"] = "新构建已下载，但无法替换当前版本。",
                ["Update.NotABuild"] = "下载到的内容不像是本项目的构建。",
                ["Update.Later"] = "稍后",
                ["About.OriginalBy"] = "原作者：{0}",
                ["About.ContinuedBy"] = "扩展和维护：{0}",
                ...
                ["Sfx.WhyNoRuntime"] = "无音效：未找到 64 位 FMOD。Everest 版本会将其安装到 lib64-win-x64；也可将这两个 DLL 放在 DeskMadeline.exe 旁边。",
                ["Sfx.WhyNoBanks"] = "无音效：未找到 Celeste 的音效库。请在“Celeste 文件夹”中指定游戏目录。",
                ["Sfx.WhyUnavailable"] = "无音效：FMOD 未能启动。详见 pet_debug.log。",
                ["Surface.Asphalt"] = "沥青",
                ["Surface.Car"] = "汽车",
                ["Surface.Dirt"] = "泥土",
                ["Surface.Snow"] = "雪地",
                ...
                ["Menu.SpawnBumper"] = "生成弹球",
                ["Menu.SpawnPuffer"] = "生成河豚",
                ["Menu.Autonomy"] = "自主活动",
                ["Menu.AutonomyDebug"] = "自主活动调试",
                ["Menu.Spawn"] = "生成",
                ...
                ["Menu.RemoveAllBumpers"] = "移除所有弹球",
                ["Menu.RemoveAllPuffers"] = "移除所有河豚",
