...
namespace DeskMadeline
{
    ...
    internal static class Loc
    {
        ...
        static readonly Dictionary<string, string> english = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Update.NoBuilds"] = "The build workflow has no finished build of master.",
            ["Update.Yours"] = "This build: {0}",
            ["Update.Newest"] = "Newest build: {0}",
            ["Update.Unknown"] = "not built from a checkout",
            ["Update.Artifact"] = "It is on that build's page on GitHub, under Artifacts. GitHub only hands those to someone signed in.",
            ...
            new Dictionary<string, Dictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["zh"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["Update.NoBuilds"] = "构建工作流中没有 master 的完成构建。",
                ["Update.Yours"] = "当前构建：{0}",
                ["Update.Newest"] = "最新构建：{0}",
                ["Update.Unknown"] = "并非由代码仓库构建",
                ["Update.Artifact"] = "下载位于该构建在 GitHub 上的页面的 Artifacts 中。GitHub 仅向已登录的用户提供下载。",
                ["Update.Download"] = "下载",
                ["Update.Later"] = "稍后",
