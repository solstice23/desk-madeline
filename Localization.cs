...
namespace DeskMadeline
{
    ...
    internal static class Loc
    {
        ...
        static readonly Dictionary<string, string> english = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Sfx.WhyNoRuntime"] = "Sound effects unavailable: they are played from a Celeste with Everest installed.",
            ...
            ["Sfx.Get"] = "Download the sound library…",
            ["Sfx.GetTitle"] = "Sound effects are not available",
            ["Sfx.GetWhy"] = "Desk Madeline plays Celeste's own sound effects. Playing them needs the game's 64-bit FMOD, which comes with a copy of Celeste that has Everest installed, and yours does not have it.\n\nHowever, you can also let Desk Madeline download the library it needs and keep it beside herself; your Celeste folder is not touched.\n\nOr leave her silent: everything else works the same, and this offer stays in the tray menu under Sound effects.",
            ["Sfx.GetFrom"] = "About 1 MB, from Everest's release on GitHub.",
            ["Sfx.Getting"] = "Downloading the sound library…",
            ["Sfx.GetDone"] = "The sound library is in place.",
            ["Sfx.RestartToApply"] = "Restart Desk Madeline now to hear her?",
            ["Sfx.RestartNow"] = "Restart now",
            ["Sfx.GetFailed"] = "The sound library could not be downloaded.",
            ["Sfx.InstallEverest"] = "Install Everest",
            ["Sfx.StaySilent"] = "Stay silent",
            ["Sfx.OnEverest"] = "Everest's page",
            ...
            new Dictionary<string, Dictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["zh"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["Sfx.WhyNoRuntime"] = "音效不可用：需要安装了 Everest 的 Celeste 副本。",
                ["Sfx.WhyNoBanks"] = "无音效：未找到 Celeste 的音效库。请在“Celeste 文件夹”中指定游戏目录。",
                ["Sfx.WhyUnavailable"] = "无音效：FMOD 未能启动。详见 pet_debug.log。",
                ["Sfx.Get"] = "下载音效库文件…",
                ["Sfx.GetTitle"] = "音效不可用",
                ["Sfx.GetWhy"] = "玛德琳桌宠播放的是 Celeste 原本的音效。播放它们需要游戏的 64 位 FMOD，而只有安装了 Everest 的 Celeste 副本才带有它，你的副本没有。\n\n不过，你也可以让玛德琳桌宠下载所需的库文件，保存在她自己旁边；不会改动你的 Celeste 目录。\n\n也可以让她保持静音：其余一切照常，此提示会保留在托盘菜单的“音效”中。",
                ["Sfx.GetFrom"] = "约 1 MB，来自 GitHub 上 Everest 的发布。",
                ["Sfx.Getting"] = "正在下载音效库文件…",
                ["Sfx.GetDone"] = "音效库文件已就位。",
                ["Sfx.RestartToApply"] = "现在重启玛德琳桌宠，让她发出声音吗？",
                ["Sfx.RestartNow"] = "立即重启",
                ["Sfx.GetFailed"] = "音效库文件下载失败。",
                ["Sfx.InstallEverest"] = "安装 Everest",
                ["Sfx.StaySilent"] = "保持静音",
                ["Sfx.OnEverest"] = "Everest 页面",
                ["Surface.Asphalt"] = "沥青",
                ["Surface.Car"] = "汽车",
                ["Surface.Dirt"] = "泥土",
                ["Surface.Snow"] = "雪地",
